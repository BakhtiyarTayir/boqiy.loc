<div class="wrap">
	...
	<table class="widefat">
		...
		<?php foreach($payments as $payment):
			...
			<td><?php echo $payment->user_id ? $payment->user_login : sprintf(__('Access code %s', 'watupro'), $payment->access_code);?></td><td><?php echo date_i18n(get_option('date_format'), strtotime($payment->date))?></td>
