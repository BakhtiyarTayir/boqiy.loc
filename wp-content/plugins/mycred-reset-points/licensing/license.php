<?php
if ( ! class_exists( 'myCRED_Reset_Point_License' ) ) :
	final class myCRED_Reset_Point_License {

		// Plugin Version
		public $version = MYCRED_PR_VERSION;

		// Plugin Slug
		public $slug    = MYCRED_PR_SLUG;

		public $base    = MYCRED_PR_THIS;
...
function mycred_reset_point_license() {
	return myCRED_Reset_Point_License::instance();
}
mycred_reset_point_license();