...
if ( ! defined( 'YITH_WCAF_SHORT' ) ) {
	define( 'YITH_WCAF_SHORT', YITH_WCAF_DIR . 'templates/shortcodes/' );
}
...
function misha_one_more_link( $menu_links ){
	...
	$new = array( 'anyuniquetext123' => __( 'Affiliate', 'yith-woocommerce-affiliates' ) );
