                ...
                array(
                    ...
                    'setting_fields' => array(
                        ...
                        array(
                            ...
                            'desc'        => wp_kses_post( 'Enter your google tag manager id (<a href="'.esc_url('https://developers.google.com/tag-manager/quickstart').'" target="_blank">Lookup your ID</a>)', 'woolentor-pro' ),
                            'class'       => 'woolentor-action-field-left',
                        ),
