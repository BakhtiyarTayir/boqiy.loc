...
class Buddypress_Ads_Rotator_Public {
	...
	public function enqueue_scripts() {
		...
		*/
		...
		wp_localize_script(
			...
			'bp_ads_check',
			array(
				'is_shortcode_page' => has_shortcode( $post->post_content, 'ads-shortcode' ) ? true : false,
			)
		);
	}
	...
	public function wb_ads_rotator_display_plain_text_and_code_ads( $wb_ads_rotator_get_ad ) {
		...
		if ( 'yes' === $wb_ads_rotator_allow_shortcode ) {
			...
			echo wp_kses( apply_filters( 'wb_ads_rotator_plain_text_code_ads_content', $wb_ads_rotator_get_plain_text ), $allowedposttags );
		}
	...
	public function wb_ads_rotator_display_rich_content_ads( $wb_ads_rotator_get_ad ) {
		...
		echo wp_kses( apply_filters( 'wb_ads_rotator_rich_content_ads_content', $wb_ads_rotator_get_rich_content ), $allowedposttags );
