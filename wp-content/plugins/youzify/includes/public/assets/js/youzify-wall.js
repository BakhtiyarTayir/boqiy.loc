...
( function( $ ) {
	...
	$( document ).ready( function() {
		...
		if ( jQuery().viewportChecker ) {
			...
			if ( $( '.youzify-column-content div.activity' )[0] ) {
				...
				youzify_observer.observe( $( '.youzify-column-content div.activity' )[0] , { attributes: false, childList: true, subtree:false, characterData: false } );
			}
			...
			if ( $( 'div.activity #activity-stream' )[0] ) {
				...
				// Pass in the target node, as well as the observer options
				youzify_observer.observe( $( 'div.activity #activity-stream' )[0] , { attributes: false, childList: true, subtree:false, characterData: false } );
			}
