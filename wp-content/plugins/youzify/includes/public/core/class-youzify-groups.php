...
class Youzify_Group {
	...
	function navbar() { ?>
		...
		<nav id="youzify-profile-navmenu" class="<?php echo $this->get_navbar_class(); ?>">
			<div class="youzify-inner-content">
				...
				<div id="youzify-group-buttons" <?php echo $parent_id == 0 ?  'style="display: none"': ' '; ?>><?php
	...
	function main_content() { ?>
		...
		<div class="youzify-right-sidebar-layout" <?php echo $parent_id == 0 ?  'style="grid-template-columns: auto;"': ' '; ?>>
	...
	function group_info_content() {
		...
		<div class="youzify-group-infos-widget">
			...
			<?php 
				//echo apply_filters( 'the_content', html_entity_decode( $group->description ) );
