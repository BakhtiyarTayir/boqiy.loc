...
class Youzify_Attachments {
    ...
    function move_attachments( $attachments, $component ) {
    	...
    	global $Youzify_upload_url, $youzify_upload_source, $youzify_upload_component;
		...
		// Get File Path.
		$temp_path = $Youzify_upload_url . 'temp/' ;
    ...
    function wml_upload( $file_url, $original_image, $new_name = false ) {
		...
		$upload_file = wp_upload_bits( $new_name, null, youzify_file_get_contents( $file_url ) );
