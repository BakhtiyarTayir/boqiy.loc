...
class Youzify_Membership_Form {
	...
	function get_actions_class( $type ) {
		...
		switch ( $type ) {
			...
			case 'register':
				...
				// Get Half Width Class.
				if ( in_array( $actions_layout, array( 'form-regactions-v4' ) ) ) {
					$actions_class[] = 'form-fullwidth-button';
				}

				// Get Button Border Style.
				$actions_class[] = youzify_option( 'youzify_signup_btn_format' );
		...
		switch ( $field['item'] ) {
			...
			case 'remember-me': ?>
		    	<div class="youzify-membership-form-item youzify-membership-remember-me">
		    		<div class="youzify-membership-item-content">
			        	<label class="youzify_membership_checkbox_field" for="rememberme">
	...
	function generate_form_actions( $actions, $attributes ) {
		...
		echo '<div class="tel_login" style="padding-top: 2rem;text-align: center;">';
		$args = array(
