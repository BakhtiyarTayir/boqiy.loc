<?php
/**
 * Plugin Name: WooCommerce Ad Form
 * Description: Добавляет форму для заполнения рекламных данных на страницу товара WooCommerce и позволяет покупать дополнительные просмотры.
 * Version: 1.1
 * Author: Your Name
 */
