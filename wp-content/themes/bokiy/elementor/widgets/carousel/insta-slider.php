...
class Insta_Slider extends Carousel_Base {

	public function get_name() {
		return 'tm-insta-slider';
	}

	public function get_title() {
		return esc_html__( 'Insta Slider', 'billey' );
	}
	...
	private function add_content_section() {
		...
		$repeater->add_control( 'title_link', [
			'label'         => esc_html__( 'Author Link', 'billey' ),
						...
						<div class="col-md-12">
							<div class="slide-content">
								...
								<div style="width: 100%; display: inline-block;">
									<a href="<?php echo $slide['title_link']['url']?>" target="_blank" rel="nofollow" tabindex="-1"><?php echo $slide['title']?></a>
