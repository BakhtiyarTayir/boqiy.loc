...
class Bonus_Main extends Base {

	public function get_name() {
		return 'tm-bonus-main';
	}

	public function get_title() {
		return esc_html__( 'Bonus Main', 'billey' );
	}
	...
	private function add_image_box_section() {
		...
		$this->add_control( 'subtitle', [
			'label'     => esc_html__( 'Subtitle', 'billey' ),
		...
		$this->add_control( 'button_user_task', [
			'label'       => esc_html__( 'Text', 'billey' ),
			'type'        => Controls_Manager::TEXT,
			'dynamic'     => [
				'active' => true,
		...
		$this->add_control( 'button_link_task', [
			'label'       => esc_html__( 'Link', 'billey' ),
			'type'        => Controls_Manager::URL,
			'dynamic'     => [
				'active' => true,
	...
	protected function render() {
		...
		<section class="b-about__top">
            <div class="b-content__warp b-content__centered">
                <div class="b-about__title"><?php echo $settings['title']?></div>
                <div class="b-about__subtitle"><?php echo $settings['subtitle']?></div>
                <div>
                    <a class="b-about__button_go " href="<?php echo $settings['button_link']['url']?>" target="_blank" rel="noopener noreferrer">
                        <?php echo $settings['button_text']?>
                    </a>
                    <div class="b-about__user-info-container">                    
                        <div class="b-about__user-tasks"><?php echo $settings['user_task']?>
                            <a class="b-about__user-tasks-link" href="<?php echo $settings['button_link_task']['url']?>"><?php echo $settings['button_user_task']?></a>
                        </div>
                    </div>
