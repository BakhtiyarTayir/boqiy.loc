...
class Bonus_Footer extends Base {

	public function get_name() {
		return 'tm-bonus-footer';
	}

	public function get_title() {
		return esc_html__( 'Bonus Footer', 'billey' );
	}
	...
	protected function render() {
		...
		<footer class="b-about__footer">
            <div class="b-content__warp b-content__centered">
                ...
                <div class="b-about__agreement b-about-subscribe__stop-text">
                    <a href="<?php echo $settings['button_link_task']['url']?>" target="_blank" rel="noopener noreferrer"><?php echo $settings['button_user_task']?></a>
                </div>                
            </div>
        </footer>
		<?php
