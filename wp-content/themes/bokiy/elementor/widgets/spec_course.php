...
class Spec_Course extends Base {

	public function get_name() {
		return 'tm-spec-courses';
	}

	public function get_title() {
		return esc_html__( 'Spec Courses', 'billey' );
	}
	...
	private function add_image_box_section() {
		...
		$this->add_control( 'content_text_1', [
			'label'     => esc_html__( 'Column 1', 'billey' ),
			'type'      => Controls_Manager::WYSIWYG,
			'dynamic' => [
				'active' => true,
			],
		] );
		$this->add_control( 'content_text_2', [
			'label'     => esc_html__( 'Column 2', 'billey' ),
			'type'      => Controls_Manager::WYSIWYG,
			'dynamic' => [
				'active' => true,
			],
		] );
		$this->add_control( 'content_text_3', [
			'label'     => esc_html__( 'Column 3', 'billey' ),
			'type'      => Controls_Manager::WYSIWYG,
			'dynamic' => [
				'active' => true,
			],
	...
	protected function render() {
		...
		?>
		<div class="container-hybrid  graduate-research-wrapper hero-right" >
        
            <div class="container graduate-research">                
				<h4 class="section-label"><?php echo $settings['title']?></h4>
                <div class="row ">

					
					
                    <div class="col-sm-6 col-lg-3 col-xl-3">
                        <div class="spec_course_item">
							<?php echo $settings['content_text_1']?>                            
                        </div>
                    </div>
					<div class="col-sm-6 col-lg-3 col-xl-3">
                        <div class="spec_course_item">
							<?php echo $settings['content_text_2']?>                            
                        </div>
                    </div>
					<div class="col-sm-6 col-lg-3 col-xl-3">
                        <div class="spec_course_item">
							<?php echo $settings['content_text_3']?>                            
                        </div>
                    </div>
					<div class="col-sm-6 col-lg-3 col-xl-3">
                        <div class="spec_course_item profile-photo margin-auto">
							<img src="<?php echo $settings['image']['url']?>" class="round_image">

                        </div>
						<div class="spec_course_link text-center">
