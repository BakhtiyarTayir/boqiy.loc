...
class Widget_block_header extends Base {

	public function get_name() {
		return 'tm-block-header';
	}

	public function get_title() {
		return esc_html__( 'Block header', 'billey' );
	}
	...
	protected function render() {
		...
		<div class="container-hybrid main" id="main-content">
            <div class="carousel slide" data-ride="carousel" id="home-hero" role="complementary" tabindex="0">
				<div aria-live="polite" class="carousel-inner">
				<div class="carousel-item active" id="tabpanel-0-0" role="tabpanel" aria-labelledby="tab-0-0">
					<div class="hero hero-1 bg-image-cover text-dark ov-slashes-panel-bottom-yellow-blue" style="background-image: url('/_assets/images/hero_home.jpg');">
					<div class="hero-body container">
			<div class="row">
				<div class="col-6 col-lg-5 col-xl-5">
					<div class="hero-content" id="tab-0-0">
						<h1 class="h2">Ready for your next challenge? The UC application is now open.&nbsp;&nbsp;</h1>
						<!--a aria-label="Read the FAQs" class="cta cta-1 text-pink d-sm-none" href="/response-covid-19.html">Read the latest press release</a> <a aria-label="Read the FAQs" class="cta cta-1 text-pink d-sm-none" href="/response-covid-19.html">See the COVID-19 FAQs</a-->
						<p class="d-none d-sm-block font-weight-bold"><span>Get your UC application in by November 30, and take the first step toward a UC degree.</span></p>
						</div>
						<p><a class="btn btn-primary btn-pink text-white" href="<?php echo $settings['Button_link']?>" role="button"><?php echo $settings['button_text']?></a></p>
						<!--a aria-label="Read the FAQs" class="btn btn-primary btn-pink d-none d-sm-block col-4 p0" href="/response-covid-19.html" role="button">Read the FAQs</a--></div>
						</div>
					</div>
				</div>
			</div>
