...
<div class="row">
	<div class="col-md-12 mb-4 mt-4"><h1><?php echo __('Cart', 'woocommerce');?></h1></div>
					...
					<li class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<div class="cart-right">
							...
							<div class="product-subtotal" data-title="<?php esc_attr_e( 'Subtotal', 'woocommerce' ); ?>">
									...
									<?php 
									if(!empty($_product->is_on_sale())){
										if(!empty($_product->get_regular_price())){
										...
										$bonussum = $product_quantity * ($regular_price - $sale_price);
									}	else {
										$bonussum = '';
									}
								?>
								...
								?>
								<div class="bonusing">
									<span class="subbonus"><?php if(!empty($bonussum)){echo $bonussum.' '.__('bonus', 'vikinger');}?> </span>
								</div>
							</div>
						</div>
					</li>
